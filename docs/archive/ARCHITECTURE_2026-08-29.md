...
> **Archived 2026-09-13.** Superseded by [`docs/ARCHITECTURE.md`](../ARCHITECTURE.md), which folds this document's runtime map forward and re-verifies it against the current codebase. Kept for historical record of the design decisions made at this point in the project.
