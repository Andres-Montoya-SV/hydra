> Current security restriction: SSLyze is excluded from the image and execution
> is blocked. See [SSLyze security hold](SSLYZE_SECURITY_HOLD.md).
...
| **wafw00f** | **Exact pin, `pip install -r requirements-optional.txt`** | Installed in the Docker image. SSLyze is excluded under the security hold above; cryptography 50.0.1 supports parsing archived certificate evidence. |
